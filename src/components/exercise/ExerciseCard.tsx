...
const ExerciseCard: React.FC<ExerciseCardProps> = ({
  ...
  return (
    <div className="col-span-1 group mx-1 my-1">
        ...
        <div className="aspect-square w-full relative overflow-scroll rounded-xl outline">
          <div className="mx-2">
            ...
            <button
              ...
              className="mx-auto mt-2 bg-gray-700 hover:bg-gray-800 text-white font-semibold py-2 px-4 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
            >
              Add to workout
            </button>
          </div>
...
<div className="flex flex-col gap-2 w-full">
  <div className="aspect-square w-full relative overflow-scroll rounded-xl outline">
    <div className="mx-2">
      ...
      <button
        onClick={() => workoutPlan.addToWorkout({ name: Name, id: Name })}
        className="mx-auto mt-2 bg-gray-700 hover:bg-gray-800 text-white font-semibold py-2 px-2 rounded-lg"
      >
        Add to workout
      </button>
    </div>
